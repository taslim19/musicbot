...
from AashikaMusicBot.utils import AdminRightsCheck
from AashikaMusicBot.utils.database import is_active_chat, is_nonadmin_chat
from AashikaMusicBot.utils.decorators.language import languageCB
from AashikaMusicBot.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await AashikaMusicBot.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
