import requests
import random
from AashikaMusicBot import app, userbot
...
@app.on_message(filters.command(["exifffffffffffffffffd","ddddddddddddddddddddddddddddddddddddddddddddvfvfvfg"], prefixes=["n", "N"]) & admin_filter)
